...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <p>To place an order please fill out the following four. The more information you can provide regarding the subject property the faster the report creation process will be completed. The absolute minimum for a report is the subject property address, or survey showing the subject property.
