...
@section('content')
        ...
        <div class="row justify-content-start flex-sm-column-reverse flex-lg-row">
            <div class="col-lg-7">
                ...
                <div style="background: url('{!! url('public/images/new-map.png') !!}') center no-repeat;height:400px;margin-bottom:30px">&nbsp;</div>
            </div>
            <div class="col-lg-5">
