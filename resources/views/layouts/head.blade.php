<head>
    ...
    <link href="{{URL::asset('public/vendor/bootstrap-4.0.0/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{URL::asset('public/css/fontawesome-all.css')}}" rel="stylesheet">
